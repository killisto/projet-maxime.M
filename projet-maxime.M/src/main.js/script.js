document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- Quiz Data & Functions ---
  const questions = [
    { question: "comment s'appelle le 1er implant de david ?", answers: ["Sandevistan", "Monkey arms", "mantis blade", "'rien"], correctIndex: 0 },
    { question: "Quel était l'école de David ?", answers: ["biologie numérique", "DRX", "Arasaka", "Corpo"], correctIndex: 2 },
    { question: "Comment s'appelle la petite amie de david?", answers: ["Rebecca", "Lucy", "Panam", "Judy"], correctIndex: 1 },
  ];
